...
function dart_precompiled($collectedClasses) {
  ...
  function MixerTest(_ballFixture, _rnd, _fastFrameCount, _lastUpdate, _bouncers, _frameQueue, _runningAverage, bodies, world, _stopwatch, _viewportScale, canvas, ctx, viewport, debugDraw, frameCount, fpsCounter, elapsedUs, worldStepTime) {
    this._ballFixture = _ballFixture;
    this._rnd = _rnd;
    this._fastFrameCount = _fastFrameCount;
    this._lastUpdate = _lastUpdate;
    this._bouncers = _bouncers;
    this._frameQueue = _frameQueue;
    this._runningAverage = _runningAverage;
    this.bodies = bodies;
    this.world = world;
    this._stopwatch = _stopwatch;
    this._viewportScale = _viewportScale;
    this.canvas = canvas;
    this.ctx = ctx;
    ...
    this.worldStepTime = worldStepTime;
  }
  MixerTest.builtin$cls = "MixerTest";
  if (!"name" in MixerTest)
    MixerTest.name = "MixerTest";
  $desc = $collectedClasses.MixerTest;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MixerTest.prototype = $desc;
  ...
  DynamicTreeNode.prototype.get$next = function() {
    return this.next;
  };
  ...
  MassData.prototype.get$mass = function() {
    return this.mass;
  };
  ...
  Color3.builtin$cls = "Color3";
  if (!"name" in Color3)
    Color3.name = "Color3";
  $desc = $collectedClasses.Color3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Color3.prototype = $desc;
  Color3.prototype.get$x = function(receiver) {
    return this.x;
  };
  Color3.prototype.set$x = function(receiver, v) {
    return this.x = v;
  };
  Color3.prototype.get$y = function(receiver) {
    return this.y;
  };
  Color3.prototype.set$y = function(receiver, v) {
    return this.y = v;
  };
  ...
  Sweep.prototype.get$angle = function() {
    return this.angle;
  };
  ...
  Body.prototype.get$invMass = function() {
    return this.invMass;
  };
  Body.prototype.get$next = function() {
    return this.next;
  };
  Body.prototype.set$next = function(v) {
    return this.next = v;
  };
  Body.prototype.set$prev = function(v) {
    return this.prev = v;
  };
  Body.prototype.get$jointList = function() {
    return this.jointList;
  };
  Body.prototype.set$jointList = function(v) {
    return this.jointList = v;
  };
  Body.prototype.get$invInertia = function() {
    return this.invInertia;
  };
  Body.prototype.get$_type = function() {
    return this._type;
  };
  Body.prototype.get$originTransform = function() {
  ...
  BodyDef.prototype.get$angle = function() {
    return this.angle;
  };
  BodyDef.prototype.get$position = function(receiver) {
    return this.position;
  };
  BodyDef.prototype.get$linearVelocity = function() {
    return this.linearVelocity;
  };
  BodyDef.prototype.get$angularVelocity = function() {
    return this.angularVelocity;
  };
  BodyDef.prototype.set$awake = function(v) {
    return this.awake = v;
  };
  BodyDef.prototype.get$active = function() {
    return this.active;
  };
  ...
  ContactManager.prototype.get$contactList = function() {
    return this.contactList;
  };
  ...
  function Contact(prev, next, manifold) {
    this.prev = prev;
    this.next = next;
    this.manifold = manifold;
  }
  ...
  Contact.prototype.set$prev = function(v) {
    return this.prev = v;
  };
  Contact.prototype.get$next = function() {
    return this.next;
  };
  Contact.prototype.set$next = function(v) {
    return this.next = v;
  };
  ...
  ContactEdge.prototype.get$other = function() {
    return this.other;
  };
  ContactEdge.prototype.set$prev = function(v) {
    return this.prev = v;
  };
  ContactEdge.prototype.get$next = function() {
    return this.next;
  };
  ContactEdge.prototype.set$next = function(v) {
    return this.next = v;
  };
  ...
  Fixture.prototype.get$box = function() {
    return this.box;
  };
  Fixture.prototype.get$next = function() {
    return this.next;
  };
  ...
  function ConstantVolumeJoint(bodies, targetLengths, targetVolume, normals, step, _impulse, _world, distanceJoints, frequencyHz, dampingRatio, type, _prev, _next, edgeA, edgeB, bodyA, bodyB, islandFlag, collideConnected, userData, localCenterA, localCenterB, invMassA, invIA, invMassB, invIB) {
    this.bodies = bodies;
    ...
    this._world = _world;
    this.distanceJoints = distanceJoints;
    ...
    this.userData = userData;
    this.localCenterA = localCenterA;
    this.localCenterB = localCenterB;
    this.invMassA = invMassA;
    this.invIA = invIA;
    this.invMassB = invMassB;
    this.invIB = invIB;
  }
  ConstantVolumeJoint.builtin$cls = "ConstantVolumeJoint";
  if (!"name" in ConstantVolumeJoint)
    ConstantVolumeJoint.name = "ConstantVolumeJoint";
  $desc = $collectedClasses.ConstantVolumeJoint;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ConstantVolumeJoint.prototype = $desc;
  function ConstantVolumeJoint_closure() {
  }
  ConstantVolumeJoint_closure.builtin$cls = "ConstantVolumeJoint_closure";
  if (!"name" in ConstantVolumeJoint_closure)
    ConstantVolumeJoint_closure.name = "ConstantVolumeJoint_closure";
  $desc = $collectedClasses.ConstantVolumeJoint_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ConstantVolumeJoint_closure.prototype = $desc;
  function ConstantVolumeJoint_initVelocityConstraints_closure() {
  }
  ConstantVolumeJoint_initVelocityConstraints_closure.builtin$cls = "ConstantVolumeJoint_initVelocityConstraints_closure";
  if (!"name" in ConstantVolumeJoint_initVelocityConstraints_closure)
    ConstantVolumeJoint_initVelocityConstraints_closure.name = "ConstantVolumeJoint_initVelocityConstraints_closure";
  $desc = $collectedClasses.ConstantVolumeJoint_initVelocityConstraints_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ConstantVolumeJoint_initVelocityConstraints_closure.prototype = $desc;
  function ConstantVolumeJoint_solveVelocityConstraints_closure() {
  }
  ConstantVolumeJoint_solveVelocityConstraints_closure.builtin$cls = "ConstantVolumeJoint_solveVelocityConstraints_closure";
  if (!"name" in ConstantVolumeJoint_solveVelocityConstraints_closure)
    ConstantVolumeJoint_solveVelocityConstraints_closure.name = "ConstantVolumeJoint_solveVelocityConstraints_closure";
  $desc = $collectedClasses.ConstantVolumeJoint_solveVelocityConstraints_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ConstantVolumeJoint_solveVelocityConstraints_closure.prototype = $desc;
  function DistanceJoint(localAnchor1, localAnchor2, u, impulse, mass, length, frequencyHz, dampingRatio, gamma, bias, type, _prev, _next, edgeA, edgeB, bodyA, bodyB, islandFlag, collideConnected, userData, localCenterA, localCenterB, invMassA, invIA, invMassB, invIB) {
  ...
  DistanceJoint.builtin$cls = "DistanceJoint";
  if (!"name" in DistanceJoint)
    DistanceJoint.name = "DistanceJoint";
  $desc = $collectedClasses.DistanceJoint;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DistanceJoint.prototype = $desc;
  DistanceJoint.prototype.get$mass = function() {
    return this.mass;
  };
  DistanceJoint.prototype.get$length = function(receiver) {
    return this.length;
  };
  function FrictionJoint(_localAnchorA, _localAnchorB, _linearImpulse, _angularImpulse, _maxForce, _maxTorque, type, _prev, _next, edgeA, edgeB, bodyA, bodyB, islandFlag, collideConnected, userData, localCenterA, localCenterB, invMassA, invIA, invMassB, invIB) {
    this._localAnchorA = _localAnchorA;
    this._localAnchorB = _localAnchorB;
    this._linearImpulse = _linearImpulse;
    this._angularImpulse = _angularImpulse;
  ...
  FrictionJoint.builtin$cls = "FrictionJoint";
  if (!"name" in FrictionJoint)
    FrictionJoint.name = "FrictionJoint";
  $desc = $collectedClasses.FrictionJoint;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FrictionJoint.prototype = $desc;
  function Joint(type, _prev, _next, edgeA, edgeB, bodyA, bodyB, islandFlag, collideConnected, userData, localCenterA, localCenterB, invMassA, invIA, invMassB, invIB) {
    this.type = type;
    this._prev = _prev;
    this._next = _next;
    this.edgeA = edgeA;
  ...
  Joint.prototype.get$_prev = function() {
    return this._prev;
  };
  Joint.prototype.get$bodyA = function() {
    return this.bodyA;
  };
  Joint.prototype.set$bodyA = function(v) {
    return this.bodyA = v;
  };
  Joint.prototype.get$bodyB = function() {
    return this.bodyB;
  };
  Joint.prototype.set$bodyB = function(v) {
    return this.bodyB = v;
  };
  Joint.prototype.get$collideConnected = function() {
    return this.collideConnected;
  };
  function JointDef(bodyA, bodyB, collideConnected) {
    this.bodyA = bodyA;
    this.bodyB = bodyB;
    this.collideConnected = collideConnected;
  }
  JointDef.builtin$cls = "JointDef";
  if (!"name" in JointDef)
    JointDef.name = "JointDef";
  $desc = $collectedClasses.JointDef;
  if ($desc instanceof Array)
    $desc = $desc[1];
  JointDef.prototype = $desc;
  JointDef.prototype.get$bodyA = function() {
    return this.bodyA;
  };
  JointDef.prototype.set$bodyA = function(v) {
    return this.bodyA = v;
  };
  JointDef.prototype.get$bodyB = function() {
    return this.bodyB;
  };
  JointDef.prototype.set$bodyB = function(v) {
    return this.bodyB = v;
  };
  JointDef.prototype.get$collideConnected = function() {
    return this.collideConnected;
  };
  function JointEdge(other, joint, prev, next) {
    this.other = other;
    this.joint = joint;
    this.prev = prev;
    this.next = next;
  }
  JointEdge.builtin$cls = "JointEdge";
  if (!"name" in JointEdge)
    JointEdge.name = "JointEdge";
  $desc = $collectedClasses.JointEdge;
  if ($desc instanceof Array)
    $desc = $desc[1];
  JointEdge.prototype = $desc;
  JointEdge.prototype.get$joint = function() {
    return this.joint;
  };
  JointEdge.prototype.set$prev = function(v) {
    return this.prev = v;
  };
  JointEdge.prototype.get$next = function() {
    return this.next;
  };
  JointEdge.prototype.set$next = function(v) {
    return this.next = v;
  };
  function RevoluteJoint(localAnchor1, localAnchor2, impulse, _motorImpulse, mass, motorMass, _enableMotor, _maxMotorTorque, _motorSpeed, _enableLimit, referenceAngle, lowerAngle, upperAngle, limitState, type, _prev, _next, edgeA, edgeB, bodyA, bodyB, islandFlag, collideConnected, userData, localCenterA, localCenterB, invMassA, invIA, invMassB, invIB) {
    this.localAnchor1 = localAnchor1;
    this.localAnchor2 = localAnchor2;
    this.impulse = impulse;
    this._motorImpulse = _motorImpulse;
    this.mass = mass;
  ...
  RevoluteJoint.builtin$cls = "RevoluteJoint";
  if (!"name" in RevoluteJoint)
    RevoluteJoint.name = "RevoluteJoint";
  $desc = $collectedClasses.RevoluteJoint;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RevoluteJoint.prototype = $desc;
  RevoluteJoint.prototype.get$mass = function() {
    return this.mass;
  };
  function RevoluteJointDef(localAnchorA, localAnchorB, referenceAngle, enableLimit, lowerAngle, upperAngle, enableMotor, motorSpeed, maxMotorTorque, type, userData, bodyA, bodyB, collideConnected) {
  ...
  RevoluteJointDef.builtin$cls = "RevoluteJointDef";
  if (!"name" in RevoluteJointDef)
    RevoluteJointDef.name = "RevoluteJointDef";
  $desc = $collectedClasses.RevoluteJointDef;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RevoluteJointDef.prototype = $desc;
  RevoluteJointDef.prototype.get$localAnchorA = function() {
    return this.localAnchorA;
  };
  RevoluteJointDef.prototype.get$localAnchorB = function() {
    return this.localAnchorB;
  };
  RevoluteJointDef.prototype.get$referenceAngle = function() {
  ...
  function World_drawShape_closure() {
  }
  World_drawShape_closure.builtin$cls = "World_drawShape_closure";
  if (!"name" in World_drawShape_closure)
    World_drawShape_closure.name = "World_drawShape_closure";
  $desc = $collectedClasses.World_drawShape_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  World_drawShape_closure.prototype = $desc;
  ...
  Demo.builtin$cls = "Demo";
  if (!"name" in Demo)
    Demo.name = "Demo";
  $desc = $collectedClasses.Demo;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Demo.prototype = $desc;
  function Demo_initializeAnimation_closure(this_0) {
    this.this_0 = this_0;
  }
  Demo_initializeAnimation_closure.builtin$cls = "Demo_initializeAnimation_closure";
  if (!"name" in Demo_initializeAnimation_closure)
    Demo_initializeAnimation_closure.name = "Demo_initializeAnimation_closure";
  $desc = $collectedClasses.Demo_initializeAnimation_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Demo_initializeAnimation_closure.prototype = $desc;
  function Demo_initializeAnimation_closure0(this_1) {
    this.this_1 = this_1;
  }
  Demo_initializeAnimation_closure0.builtin$cls = "Demo_initializeAnimation_closure0";
  if (!"name" in Demo_initializeAnimation_closure0)
    Demo_initializeAnimation_closure0.name = "Demo_initializeAnimation_closure0";
  $desc = $collectedClasses.Demo_initializeAnimation_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Demo_initializeAnimation_closure0.prototype = $desc;
